...
Public Class FrmJefes
    ...
    Sub carga_folio()
        Try
            ...
            sqlfolioDepto.CommandText = ("select distinct folio  from requerimiento  where requerimiento.Id_Depto  ='" & CInt(MenuJefes.Label_Id_Depto.Text) & "'" & "order by folio desc")
